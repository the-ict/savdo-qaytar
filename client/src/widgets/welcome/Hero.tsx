            ...
            <div className="custom-container relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                        Bozorni qayta ko'ring, strategiyalaringizni sinab ko'ring va xatolar ustida ishlang.
                        Haqiqiy pulingizni xavf ostiga qo'ymasdan professional treyderga aylaning.
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
                        <Button size="lg" className="font-bold premium-gradient text-white h-14 px-8 text-lg rounded-xl shadow-xl shadow-primary/20 group">
                            Bepul boshlang
                        </Button>
                        <Button size="lg" variant="outline" className="font-bold h-14 px-8 text-lg rounded-xl border-2">
                        ...
                        <div className="w-full h-full bg-[#0d1117] rounded-xl overflow-hidden relative">
                            ...
                            <div className="h-full w-full flex items-center justify-center opacity-20">
                                <div className="grid grid-cols-12 gap-1 w-3/4">
                                    {[45, 62, 38, 71, 54, 29, 66, 41, 78, 52, 33, 61, 47, 69, 35, 58, 43, 75, 49, 31, 64, 56, 39, 67].map((h, i) => (
                                        <div key={i} className="h-20 bg-white/10 rounded-sm" style={{ height: `${h}px` }} />
                                    ))}
                                </div>
                            </div>
                        </div>
