...
const stats = [
  {
    label: 'Faol treyderlar',
    value: '10,000+',
    description: "Dunyo bo'ylab 10,000 dan ortiq treyderlar bizga ishonishadi.",
  },
  {
    label: 'Strategiyalar',
    value: '50,000+',
    description: "Muvaffaqiyatli sinovdan o'tkazilgan savdo strategiyalari.",
  },
  {
    label: 'Tezlik',
    value: '100x',
    description: 'Real vaqtga qaraganda 100 baravar tezroq backtesting.',
  },
];
      ...
      <div className="custom-container">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Raqamlar bizning platformamizning samaradorligini isbotlaydi.
            Mukammallikka biz bilan erishing.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {stats.map((stat, idx) => (
            <div
              key={idx}
              className="glass p-8 rounded-3xl border-primary/10 hover:border-primary/30 transition-colors group"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center glass p-8 md:p-12 rounded-[3rem] border-primary/5">
          <div className="max-w-md">
            <h3 className="text-3xl font-bold mb-6">
              Muvaffaqiyatli treyder bo'lish siri nimada?
            </h3>
            <p className="text-muted-foreground text-lg mb-8">
              "Professional treyderlar bozor tarixini qayta-qayta ko'rishadi.
              Strategiyani yuzlab marta sinab ko'rmasdan turib, real hisobda
              savdo qilish - bu tavakkaldir."
            </p>
