...
const features = [
  {
    ...
    label: 'Backtesting',
    description:
      "Bozor tarixini soniyalar ichida o'tkazing. O'tmishdagi har bir shamni (candle) xuddi real vaqtdagidek tahlil qiling.",
    points: [
      'Milli-soniyalik aniqlik',
      'Custom periodlar',
      "Multi-chart ko'rinishi",
    ],
    icon: History,
  },
  {
    ...
    label: 'Analitika',
    description:
      "Sizning savdo natijalaringiz chuqur tahlil qilinadi. Win-rate, Risk/Reward va Drawdown kabi ko'rsatkichlarni ko'ring.",
  ...
  },
  {
    ...
    label: 'Jurnal',
    description:
      "Har bir savdoni suratlar va izohlar bilan saqlang. O'z hissiyotlaringizni va qarorlaringizni yozib boring.",
      ...
      <div className="custom-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl font-bold mb-4">
            Nega aynan <span className="text-primary italic">qaytasavdo</span>?
          </h2>
          <p className="text-muted-foreground text-lg">
            Biz treyderlar uchun treyderlar tomonidan yaratilgan eng mukammal
            backtesting platformasini taklif etamiz.
          </p>
        </div>
