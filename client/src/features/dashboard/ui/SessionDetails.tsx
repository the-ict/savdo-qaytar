        ...
        <div className="min-h-screen bg-[#0d1117] text-white pt-24 pb-20 px-8 container mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    <Link href="/dashboard" className="size-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors">
                        <ArrowLeft className="size-5 text-muted-foreground" />
                    </Link>
                    <div>
                        <div className="flex items-center gap-3">
                            <h1 className="text-3xl font-black uppercase tracking-tight">{session.pair}</h1>
                        ...
                        <div className="flex items-center gap-4 text-sm text-muted-foreground font-medium mt-1">
                            <span className="flex items-center gap-1.5"><Calendar className="size-4" /> {session.date}</span>
                            <span className="flex items-center gap-1.5"><Clock className="size-4" /> {session.trades} trades</span>
                ...
                <div className="flex items-center gap-4">
                    <Button variant="ghost" className="rounded-xl border border-white/10 bg-white/5 hover:bg-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <Card className="p-6 glass-dark border-white/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Sof Foyda</p>
                            <p className="text-2xl font-black text-white mt-1">{session.pnl}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-6 glass-dark border-white/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-black text-white mt-1">{session.winRate}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-6 glass-dark border-white/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Profit Factor</p>
                            <p className="text-2xl font-black text-white mt-1">{session.profitFactor}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-6 glass-dark border-white/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Max Drawdown</p>
                            <p className="text-2xl font-black text-white mt-1">{session.maxDrawdown}</p>
                        </div>
                    </div>
                </Card>
            </div>
