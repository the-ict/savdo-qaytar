...
export const Dashboard = () => {
    const [activeTab, setActiveTab] = useState<'statistics' | 'sessions'>('sessions');
                ...
                <div className="h-full px-8 flex items-center justify-between">
                    ...
                    <div className="relative p-1 bg-white/5 rounded-2xl border border-white/5 flex items-center gap-1">
                        ...
                        <button
                            ...
                            className={cn(
                                "px-6 py-2 cursor-pointer rounded-xl text-xs font-black uppercase tracking-widest transition-all duration-300", activeTab === 'sessions'
                                ? "bg-primary text-white shadow-lg"
                                : "text-muted-foreground hover:text-white"
                            )}
                        >
                            ...
                            <DropdownMenuTrigger className="outline-none">
                                <div className="flex items-center cursor-pointer gap-3 p-1.5 pr-3 hover:bg-white/5 rounded-2xl transition-all group">
                                    ...
                                    <div className="hidden lg:block text-left">
                                        ...
                                        <p className="text-[10px] text-muted-foreground mt-1">Sizga xush kelibsiz</p>
                                    </div>
                                    <ChevronDown className="size-4 text-muted-foreground group-hover:text-white transition-colors" />
                                </div>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent align="end" className="w-56 glass-dark border-white/10 rounded-2xl p-2 mt-2">
                                <DropdownMenuLabel className="px-3 py-2 text-xs font-black uppercase tracking-widest text-muted-foreground">Mening Hisobim</DropdownMenuLabel>
